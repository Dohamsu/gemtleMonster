...
| `mine` | 광산 | 생산 | 돌, 광석, 보석 파편 | 광물 자원 수급처 |
| `blacksmith` | 대장간 | 생산 | 금속 주괴 | 광석을 주괴로 제련 |
| `alchemy_workshop` | 연금술 공방 | 생산 | 가공된 약초 | 기초 연금 재료 가공 |
...
| `dungeon_dispatch` | 자동 던전 파견소 | 전투 | (던전 보상) | 자동 사냥 관리 시설 |
